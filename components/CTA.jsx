...
const CTA = () => {
  return (
    <section className="relative py-10 overflow-hidden bg-white sm:py-16 lg:py-24 xl:py-32">
    <div className="absolute inset-0">
        <Image height={150} width={150} className="object-cover w-full h-full md:object-left md:scale-150 md:origin-top-left" src="/images/4.jpg" alt="" />
    </div>

  {/* <div className="absolute inset-0 hidden bg-gradient-to-r md:block from-black to-transparent"></div> */}

    <div className="absolute inset-0 block bg-gray-200 md:hidden"></div>
    ...
    <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
            ...
            <p className="mt-4 text-base text-black">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam.</p>
